...
public class Veranstaltungen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String siteName = "http://study.mipsol.com/kalender/";
        setContentView(R.layout.veranstaltungen);

        final WebView webView = (WebView) findViewById(R.id.webView_veranstaltungen);
